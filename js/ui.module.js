       ...
       for (let i = 0; i < data.length; i++) {
          ...
          <div data-id="${data[i].id}"  class="card h-100 bg-transparent" role="button" ">
             <div  class="card-body">
                ...
                <figcaption>
                   ...
                   <div class="hstack justify-content-between">
                      <h3 class="h6 small badge badge-color">${data[i].title}</h3>
             ...
             <footer class="card-footer small hstack justify-content-between">
                ...
                <span class="my-badge badge badge-color">${data[i].genre}</span>
                <span class=" my-badge badge badge-color">${data[i].platform}</span>
